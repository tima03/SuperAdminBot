...
<p><strong>Далее в файле .env настройте все необходимые API: <code>PG_LINK=postgresql://username:password*@host:port/database #PostgreSQL link to your Database
